...
# You can redistribute it аnd/or modify it under the terms of the GNU AGPLv3
...
class Heroku:
    ...
    async def _main(self):
        """Main entrypoint"""
        self._get_api_token()  # Initialize api_token first
        self._init_web()  # Then initialize web
        save_config_key("port", self.arguments.port)
        await self._get_token()  # Wait for API input via web if needed
